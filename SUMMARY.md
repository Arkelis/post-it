...
* [Python](post-it/python/README.md)
  ...
  * [pipx - Installation d'applications Python](post-it/python/pipx.md)
  ...
  * [Flask-Migrate : Migrations avec SQLAlchemy & Alembic dans Flask.](post-it/python/flask-migrate.md)
* [Git](post-it/git/README.md)
  * [core.sshCommand](post-it/git/core.sshcommand.md)
* [Outils en ligne de commande](post-it/cli/README.md)
  * [smartctl : outil de contrôle et de surveillance pour les disques durs SMART](post-it/cli/cli-smartctl.md)
  * [chmod - Permissions de fichiers et répertoires](post-it/cli/cli-chmod.md)
  * [dpkg - Gestion de paquets DEB](post-it/cli/cli-dpkg.md)
...
* [Web](post-it/web/README.md)
  ...
  * [CSS - display: flex](post-it/web/css-flex.md)
...
* [Notes générales Linux](post-it/gnulinux/README.md)
  ...
  * [Debian](post-it/gnulinux/dist-debian.md)
  * [Fedora](post-it/gnulinux/dist-fedora.md)
  * [KDE](post-it/gnulinux/de-kde.md)
* [Services et démons](post-it/ds/README.md)
  * [avahi-daemon - découverte du réseau local](post-it/ds/ds-avahi-daemon.md)
